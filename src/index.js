document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    const percentageCompleted =
      ((quiz.currentQuestionIndex + 1) * 100) / quiz.questions.length;
    progressBar.style.width = percentageCompleted + "%"; // This value is hardcoded as a placeholder
    ...
    choices.forEach((choiceValue) => {
      ...
      inputTag.setAttribute("value", choiceValue);
      let label = document.createElement("label");
      label.innerText = choiceValue;
